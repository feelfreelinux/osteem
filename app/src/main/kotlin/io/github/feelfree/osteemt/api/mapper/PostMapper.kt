...
val PostMapper : Mapper<PostResponse, Post> = {
    Post(it.id, it.author, it.permlink, it.category, it.created.toPrettyDate(), it.title, it.pendingPayoutValue, it.children, it.votes, it.description, it.body, it.images, it.links, it.tags)
}